...
uint8_t WkWriteSlaveFifo(uint8_t port,uint8_t *dat,uint16_t num);
uint8_t WkReadSlaveFifo(uint8_t port,uint8_t *rec,uint16_t num);
uint8_t WkMasterUartBaudAdaptive(void);
void WkUartInit(uint8_t port);
void WkUartDeInit(uint8_t port);

uint8_t WkUartSetBaud(uint8_t port,uint32_t baudrate);
uint8_t WkUartFormatSet(uint8_t port,uint8_t stopformat,uint8_t paritytype);

uint16_t WkUartTxLen(uint8_t port);
uint16_t WkUartTxChars(uint8_t port,int len,uint8_t *sendbuf);

uint16_t WkUartRxChars(uint8_t port,uint8_t *recbuf);
